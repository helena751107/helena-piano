...
const ACCOUNT_MAP = {
  a: { email: 'REDACTED', token: 'accounts/token_a.json' },
  b: { email: 'REDACTED@gmail.com',          token: 'accounts/token_b.json' },
  c: { email: 'REDACTED',      token: 'accounts/token_c.json' },
  d: { email: 'REDACTED',              token: 'accounts/token_d.json' }
};
