...
> **대상**: `dtslib1979/parksy-audio` + 28개 연계 레포  
...
| 파일 | 내용 |
|------|------|
| [01-repo-list.md](01-repo-list.md) | dtslib1979 소유 28개 레포 + helena751107 6개 레포 전체 목록 |
...
1. **오디오 레포는 이미 존재**: `dtslib1979/parksy-audio` — 986MB, MIDI 렌더링·인간화·마스터링·YouTube 송출 풀스택
